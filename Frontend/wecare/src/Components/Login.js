...
<div class="h-screen flex">
  <div class="flex w-1/2 bg-gradient-to-tr from-blue-300 to-blue-400 i justify-around items-center">
    <div>
  ...
  <div class="flex w-1/2 justify-center items-center bg-white">
    <form class="bg-white">
      ...
      <button type="submit" class="block w-full bg-blue-400 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Login</button>
